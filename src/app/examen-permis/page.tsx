...
import { BookOpen, FileCheck, Award, UserCheck, Clock } from "lucide-react";

export const metadata = {
  title: "Processus d&apos;Examen - Auto-École La Capitale",
  description:
    "Les 5 étapes pour obtenir votre permis de conduire au Togo. De l&apos;inscription à la délivrance du permis définitif.",
};
  ...
  const steps = [
    {
      ...
      content:
        "Apprentissage du Code de la route, notions de mécanique et de secourisme. Pratique de la conduite avec nos moniteurs agréés.",
      color: "bg-brand-blue",
    },
    {
      id: 2,
      ...
      content: (
        <ul className="list-disc list-inside text-gray-600 space-y-1">
          ...
          <li>
            <strong>Frais de Quittance : 30 000 F CFA</strong>
          </li>
        </ul>
      ),
      color: "bg-secondary",
    },
    {
      ...
      content:
        "Passage de l&apos;examen théorique (Code) puis de l&apos;examen pratique (Conduite) devant les inspecteurs.",
      color: "bg-primary",
    },
    {
      id: 4,
      ...
      content:
        "Délivrance d'un titre provisoire vous autorisant à conduire en attendant le document final.",
      color: "bg-accent",
    },
    {
      id: 5,
        ...
        <div className="relative">
          ...
          {steps.map((step, index) => (
            ...
            >
              {/* Timeline Node */}
              <div
                className={`absolute left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full border-4 border-white shadow-lg flex items-center justify-center z-10 ${step.color} hidden md:flex`}
              >
              ...
              <div className="w-full md:w-1/2 p-4 md:px-10">
                <div className="bg-gray-50 p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition relative">
                  {/* Mobile Badge */}
                  <div
                    className={`md:hidden absolute -top-5 left-6 w-10 h-10 rounded-full flex items-center justify-center shadow-lg ${step.color}`}
                  >
                    <span className="font-bold text-white">{step.id}</span>
                  </div>
                  ...
                  <div className="flex items-center mb-4 mt-2 md:mt-0">
                    <div
                      className={`p-2 rounded-lg mr-4 ${step.color} bg-opacity-90`}
                    >
                      {step.icon}
                    </div>
                    <div>
